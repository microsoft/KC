This repository contains code, datasets, and links related to the [**Knowledge Computing** (**KC**)](https://www.microsoft.com/en-us/research/group/knowledge-computing/) group at Microsoft Research Asia (MSRA).
