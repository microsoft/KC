...
def build_out_anchor_relations(in_fn, crash_cache_dir, redis_port):
        ...
        with open(os.path.join(crash_cache_dir, "skip_entities.jsonl"),
            ...
            for line in tqdm(fp):
                ...
                if entity['id'] in done_entities:
                    continue
                out_relations = list(entity['one_hop_facts'].keys())
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sro_file", type=str, required=True, help="path to merged_sro_per_line.json")
    parser.add_argument("--crash_cache_dir", type=str, required=True, help="path to crash_cache_dir")
    parser.add_argument("--redis_port", type=int, default=6385)
    args = parser.parse_args()
    build_out_anchor_relations(args.sro_file,
