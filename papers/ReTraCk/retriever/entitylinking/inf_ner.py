...
def process_one_file(model, in_fn, out_fn, dataset="GrailQA"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint", type=str, default="out_base_uncased_GrailQA_datetime/")
    ...
    model = Ner(args.checkpoint)
    process_one_file(model, args.in_fn, args.out_fn, dataset=args.dataset)
